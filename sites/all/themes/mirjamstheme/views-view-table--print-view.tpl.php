...
foreach ($rows as $count => $row):
	...
	print (stripos($title,"</")==0) ? ('No Sales Company'): (substr($title, stripos($title,">",1)+1, stripos($title,"</") - stripos($title,">",1)-1));
	print "</p>";
...
// print array
	...
	print "<table class='print_top_box'><colgroup><col width='10%'><col width='35%'><col width='12%'></colgroup>";
	...
	print "</table><table class='print_middle_box'><colgroup><col width='10%'><col width='75%'></colgroup>";
